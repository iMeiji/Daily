...
public class PostsListNewView extends BaseNewFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static PostsListNewView newInstance(String slug, String title, int postsCount) {
        ...
        args.putString(Constant.ZHUANLANBEAN_SLUG, slug);
        args.putString(Constant.ZHUANLANBEAN_NAME, title);
        args.putInt(Constant.ZHUANLANBEAN_POSTSCOUNT, postsCount);
    ...
    protected void initData() {
        ...
        if (arguments != null) {
            mSlug = arguments.getString(ZHUANLANBEAN_SLUG);
            mPostCount = arguments.getInt(ZHUANLANBEAN_POSTSCOUNT, 0);
            String title = arguments.getString(ZHUANLANBEAN_NAME);
    ...
    protected void subscribeUI() {
        ...
        mModel.getIsEnd().observe(this, new Observer<Boolean>() {
            @Override
            public void onChanged(@Nullable Boolean aBoolean) {
